...
export const ExamReviewView: React.FC<ExamReviewProps> = ({ result, onBack }) => {
  ...
  return (
    <div style={{ maxWidth: '950px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      >
        <div>
          <span style={{ fontSize: '0.8rem', fontWeight: 700, padding: '0.2rem 0.6rem', borderRadius: 'var(--radius-full)', background: 'rgba(0, 240, 255, 0.2)', color: 'var(--accent-cyan)' }}>
        ...
        {filteredQuestions.map((q, idx) => {
          ...
          return (
            <Card key={q.id} hoverable={false} style={{ padding: '1.5rem', borderLeft: `4px solid ${isCorrect ? 'var(--accent-green)' : '#FF3333'}` }}>
              ...
              <div style={{ background: 'rgba(0, 240, 255, 0.05)', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid rgba(0, 240, 255, 0.2)', marginTop: '1rem' }}>
