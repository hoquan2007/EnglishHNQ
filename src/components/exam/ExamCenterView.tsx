      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
            ...
            <h1 style={{ margin: 0, fontSize: '2rem', background: 'linear-gradient(135deg, #00F0FF, #7000FF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        ...
        <Card hoverable={false} style={{ padding: '1rem 1.5rem', background: 'rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <BookOpen size={32} color="#00F0FF" />
          <div>
            <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>TỔNG SỐ ĐỀ THI</span>
            <strong style={{ fontSize: '1.4rem', color: '#00F0FF', display: 'block' }}>500 BỘ ĐỀ</strong>
          </div>
        </Card>
      </div>
          ...
          <Card key={exam.id} hoverable style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '1.5rem' }}>
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                <span style={{ fontSize: '0.75rem', fontWeight: 700, padding: '0.2rem 0.6rem', borderRadius: 'var(--radius-full)', background: 'rgba(0, 240, 255, 0.15)', color: 'var(--accent-cyan)', border: '1px solid rgba(0, 240, 255, 0.3)' }}>
                  CẤP ĐỘ {exam.level}
                </span>
