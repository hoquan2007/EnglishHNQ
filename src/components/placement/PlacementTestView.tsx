  ...
  if (isCompleted && resultData) {
    return (
      <div className="glass-panel" style={{ padding: '3rem', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', padding: '1.5rem', borderRadius: '50%', background: 'rgba(0, 240, 255, 0.1)', marginBottom: '1.5rem' }}>
  ...
  if (!started) {
    return (
      <div className="glass-panel" style={{ padding: '3.5rem', maxWidth: '850px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', padding: '1.25rem', borderRadius: '50%', background: 'rgba(138, 43, 226, 0.15)', marginBottom: '1.5rem' }}>
