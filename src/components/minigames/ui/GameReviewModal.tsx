                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {!item.isCorrect && (
                    <button
                      ...
                      style={{
                        background: savedItems[idx] ? 'rgba(52, 211, 153, 0.2)' : 'rgba(0, 240, 255, 0.1)',
                        border: savedItems[idx] ? '1px solid rgba(52, 211, 153, 0.4)' : '1px solid rgba(0, 240, 255, 0.3)',
                        color: savedItems[idx] ? '#34d399' : '#00F0FF',
                        fontSize: '0.75rem',
                        fontWeight: 600,
                        padding: '4px 10px',
                        borderRadius: '8px',
