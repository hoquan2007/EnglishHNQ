      ...
      {activeLesson ? (
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
            ...
            <span className="badge" style={{ background: 'rgba(255, 0, 127, 0.2)', color: 'var(--accent-pink)' }}>
          ...
          <div className="glass-panel" style={{ padding: '2.5rem', marginBottom: '2rem' }}>
                  ...
                  <div key={i} className="glass-card" style={{ padding: '1.25rem', borderLeft: '4px solid var(--accent-cyan)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.35rem' }}>
                      ...
                      <button
                        ...
                        style={{ background: 'rgba(0, 240, 255, 0.15)', padding: '0.35rem', borderRadius: '50%', color: 'var(--accent-cyan)' }}
                      >
                        <Volume2 size={18} />
                      </button>
                    </div>
            ...
            {activeLesson.quizzes.length > 0 && (
              <div className="glass-panel" style={{ padding: '2rem', background: 'rgba(0, 0, 0, 0.3)', border: '1px solid rgba(255, 0, 127, 0.3)' }}>
