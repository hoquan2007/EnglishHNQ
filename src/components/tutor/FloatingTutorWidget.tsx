  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'floating_init',
      sender: 'tutor',
      text: `Xin chào ${user.name}! Cần thầy Dr. HNQ hỗ trợ giải đáp điều gì ngay lúc này không?`,
  ...
  return (
    <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 9999 }}>
      ...
      {isOpen && (
        <div
          ...
          style={{
            ...
            boxShadow: '0 20px 40px rgba(0, 0, 0, 0.5), 0 0 20px rgba(0, 240, 255, 0.2)',
        ...
        >
          ...
          <div
            style={{
              padding: '1rem',
              background: 'linear-gradient(135deg, rgba(138, 43, 226, 0.4), rgba(0, 240, 255, 0.2))',
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <strong style={{ fontSize: '0.95rem' }}>Dr. HNQ - Floating AI Tutor</strong>
            </div>
            <button
          ...
          >
            ...
            {isThinking && (
              <div style={{ fontSize: '0.8rem', color: 'var(--accent-cyan)', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                <Sparkles size={14} className="pulse-glow" /> Dr. HNQ đang suy nghĩ...
              </div>
            )}
          </div>
          ...
          <div style={{ padding: '0.75rem', borderTop: '1px solid var(--glass-border)', display: 'flex', gap: '0.5rem' }}>
            <input
              ...
              placeholder="Hỏi nhanh thầy Dr. HNQ..."
              style={{
                flex: 1,
      ...
      <button
        ...
        title="Trò chuyện nhanh với AI Gia Sư Dr. HNQ"
      >
