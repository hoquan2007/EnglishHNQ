...
export const CentralTutorView: React.FC<CentralTutorViewProps> = ({
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      id: 'init_tutor',
      sender: 'tutor',
      text: `Xin chào ${user.name}! Thầy là Dr. HNQ - Gia sư AI Tổng quản của bạn. Thầy nắm rõ toàn bộ dữ liệu học tập của bạn (Rank ${user.rank.toUpperCase()}, ${user.xp} XP). Bạn có câu hỏi nào cần thầy tư vấn hoặc giải đáp không?`,
  ...
  // Handle Send Chat Message to Dr. HNQ
  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
      ...
      <div
        ...
        style={{
          padding: '2.5rem',
          background: 'linear-gradient(135deg, rgba(18, 24, 36, 0.95), rgba(0, 240, 255, 0.15))',
      ...
      >
        <div style={{ maxWidth: '650px' }}>
          ...
          <h1 style={{ fontSize: '2.2rem', marginBottom: '0.5rem', lineHeight: 1.2 }}>
            Dr. HNQ - <span className="gradient-text">Gia Sư AI Tổng Quản</span>
          </h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem' }}>
            ...
            <Card hoverable={false}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ padding: '0.6rem', borderRadius: '12px', background: 'rgba(255, 0, 127, 0.15)', color: 'var(--accent-pink)' }}>
                  <Sparkles size={22} />
                </div>
              </div>
            </Card>
          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', fontSize: '0.92rem' }}>
              Dr. HNQ tự động tổng hợp 4 nhiệm vụ ưu tiên nhất dựa trên các điểm yếu bạn mắc phải gần đây:
            </p>
            ...
            <Card hoverable={false}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', maxHeight: '240px', overflowY: 'auto' }}>
                {analytics.chatFixHistory.map((item) => (
                  <div key={item.id} style={{ padding: '0.75rem', background: 'rgba(255, 0, 127, 0.08)', borderLeft: '3px solid var(--accent-pink)', borderRadius: '6px' }}>
      ...
      {tutorTab === 'remediation' && (
        <div className="glass-panel" style={{ padding: '2.5rem', maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            ...
            <span className="badge" style={{ background: 'rgba(138, 43, 226, 0.2)', color: 'var(--accent-purple)' }}>
              +40 XP Phần Thưởng
            </span>
          </div>
          ...
          {quizFinished ? (
            ...
            <div>
              ...
              {showExplanation && (
                <div className="glass-card" style={{ padding: '1rem', marginBottom: '1.5rem', background: 'rgba(0, 240, 255, 0.08)' }}>
                  <strong style={{ color: 'var(--accent-cyan)' }}>💡 Giải thích chi tiết từ Dr. HNQ: </strong>
      ...
      {tutorTab === 'chat' && (
        <div className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', height: '620px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', paddingBottom: '0.75rem', marginBottom: '0.75rem', borderBottom: '1px solid var(--glass-border)' }}>
            ...
            <h3 style={{ margin: 0 }}>Trò Chuyện 1:1 Với Dr. HNQ - Central AI Master Tutor</h3>
          </div>
          ...
          <div ref={chatScrollRef} style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '1rem', paddingRight: '0.5rem' }}>
              ...
              <div key={msg.id} style={{ display: 'flex', justifyContent: msg.sender === 'user' ? 'flex-end' : 'flex-start' }}>
                <div
                  style={{
                    ...
                    borderRadius: '16px',
                    background: msg.sender === 'user' ? 'linear-gradient(135deg, var(--accent-purple), #6c5ce7)' : 'rgba(255, 255, 255, 0.07)',
                ...
                >
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.3rem', fontWeight: 600 }}>
                    {msg.sender === 'user' ? user.name : 'Dr. HNQ (AI Master Tutor)'} • {msg.timestamp}
                  </div>
            ...
            {isThinking && (
              <div style={{ color: 'var(--accent-cyan)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <Sparkles size={16} className="pulse-glow" /> Dr. HNQ đang phân tích dữ liệu và soạn câu trả lời...
              </div>
            )}
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid var(--glass-border)' }}>
            ...
            <input
              ...
              placeholder="Đặt câu hỏi cho thầy Dr. HNQ..."
              style={{
                flex: 1,
