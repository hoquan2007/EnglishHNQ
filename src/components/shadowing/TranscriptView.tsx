      ...
      >
        ...
        <button
          ...
          style={{
            ...
            alignItems: 'center',
            gap: '0.4rem',
            background: showTranslation ? 'rgba(0, 240, 255, 0.15)' : 'rgba(255, 255, 255, 0.06)',
            color: showTranslation ? 'var(--accent-cyan)' : 'var(--text-secondary)',
            border: showTranslation ? '1px solid rgba(0, 240, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.1)',
            ...
            <div
              ...
              style={{
                ...
                background: isSelected
                  ? 'linear-gradient(135deg, rgba(0, 240, 255, 0.15), rgba(138, 43, 226, 0.15))'
                  : isActiveTime
                  ? 'rgba(0, 240, 255, 0.08)'
