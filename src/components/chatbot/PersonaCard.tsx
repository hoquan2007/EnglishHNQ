    ...
    <div
      ...
      style={{
        ...
        boxShadow: isSelected
          ? `0 0 20px ${isAdam ? 'rgba(0, 240, 255, 0.25)' : 'rgba(255, 0, 127, 0.25)'}`
          : 'none',
        ...
        <div
          style={{
            ...
            background: isAdam
              ...
              : 'linear-gradient(135deg, #ff007f, #8a2be2)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            fontSize: '1.75rem',
            boxShadow: `0 4px 15px ${isAdam ? 'rgba(0, 240, 255, 0.4)' : 'rgba(255, 0, 127, 0.4)'}`,
          }}
        >
          {isAdam ? '👨‍💼' : '👩‍🏫'}
        </div>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <span
              className="badge"
              style={{
                background: isAdam ? 'rgba(0, 240, 255, 0.15)' : 'rgba(255, 0, 127, 0.15)',
                color: isAdam ? 'var(--accent-cyan)' : 'var(--accent-pink)',
                border: `1px solid ${isAdam ? 'rgba(0, 240, 255, 0.3)' : 'rgba(255, 0, 127, 0.3)'}`,
                fontSize: '0.7rem',
              }}
            >
