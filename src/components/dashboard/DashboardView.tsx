  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div
        ...
        style={{
          padding: '2.5rem',
          background: 'linear-gradient(135deg, rgba(18, 24, 36, 0.9), rgba(138, 43, 226, 0.2))',
      ...
      >
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '700px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            <span className="badge" style={{ background: 'rgba(0, 240, 255, 0.15)', color: 'var(--accent-cyan)', border: '1px solid rgba(0, 240, 255, 0.3)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem' }}>
        ...
        <Card hoverable={false}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
            ...
            <div style={{ padding: '0.6rem', borderRadius: '12px', background: 'rgba(138, 43, 226, 0.15)', color: 'var(--accent-purple)' }}>
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
          ...
          <Card onClick={() => onNavigate('vocabulary')}>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              <div style={{ padding: '0.8rem', borderRadius: '14px', background: 'linear-gradient(135deg, var(--accent-cyan), #00a8ff)', color: '#000' }}>
                <BookOpen size={28} />
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
